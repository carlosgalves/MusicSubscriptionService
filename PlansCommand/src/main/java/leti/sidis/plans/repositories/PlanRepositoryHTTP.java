...
public class PlanRepositoryHTTP implements PlanRepository{
    ...
    private final int subscriptionsQueryPort1 = Integer.parseInt(dotenv.get("SUBSCRIPTIONS_QUERY_PORT1"));
    private final int subscriptionsQueryPort2 = Integer.parseInt(dotenv.get("SUBSCRIPTIONS_QUERY_PORT2"));
    ...
    public List<Map<String, Object>> findSubscriptionsWithPlan(String planName) {
        int targetPort = (currentPort ==  subscriptionsQueryPort1) ? subscriptionsQueryPort2 : subscriptionsQueryPort1;
