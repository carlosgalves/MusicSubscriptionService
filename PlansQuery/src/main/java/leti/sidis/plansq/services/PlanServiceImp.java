...
public class PlanServiceImp implements PlanService {
   ...
   // private final PlanRepositoryHTTP httpRepository;
    ...
    public PlanServiceImp(PlanRepositoryJPA jpaRepository, EditPlanMapper planEditMapper /*PlanRepositoryHTTP httpRepository*/) {
 ...
 /*   @Override
    public Plan createPlan(final CreatePlanRequest resource) {
        ...
        if (jpaRepository.findByPlanName(resource.getPlanName()) != null || httpRepository.findByPlanName(resource.getPlanName()) != null) {
